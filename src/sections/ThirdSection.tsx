    ...
    <section className='py-6 px-4 sm:px-8'>
      <div className="container mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between w-full">
          <Image src="/static/frame-tag.png" alt="Google Tag Manager" className='mb-16 sm:mb-0 w-full max-w-[200px] sm:w-1/4 sm:max-w-[261px]' />
          <Image src="/static/arrow.png" alt="Arrow" className='rotate-90 sm:rotate-0 w-16 sm:w-1/8 max-w-[165px] -translate-y-8 sm:translate-y-0' />
          <Image src="/static/frame-ads.png" alt="Google Ads" className='mb-16 sm:mb-0 w-full sm:w-1/4 max-w-[200px] sm:w-1/4 sm:max-w-[261px]' />
          <Image src="/static/arrow.png" alt="Arrow" className='rotate-90 sm:rotate-0 w-16 sm:w-1/8 max-w-[165px] -translate-y-8 sm:translate-y-0' />
          <Image src="/static/frame-analytics.png" alt="Google Analytics" className='w-full sm:w-1/4 max-w-[200px] sm:w-1/4 sm:max-w-[261px]' />
        </div>
      </div>
    </section>
  );
